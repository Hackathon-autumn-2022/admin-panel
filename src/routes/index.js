...
import EditExponent from "../pages/EditExponent"
...
const authProtectedRoutes = [
  ...
  {path: '/exps', component: Exponents},
  {path: '/exps/:expId', component: EditExponent},
  {path: '/exps/add', component: EditExponent},

  // this route should be at the end of all other routes
  // eslint-disable-next-line react/display-name
  { path: "/", exact: true, component: () => <Redirect to="/exps" /> },
  { path: "/dashboard", exact: true, component: () => <Redirect to="/exps" /> },
]
